...
3) Interactive Charts (Category-wise and Monthly analysis using Chart.js)
4) Monthly Expense Breakdown Table
5) Expandable Transaction History
6) Dark and Light Mode Toggle
7) Data Export
8) CSV (Excel format)
9) PDF Report
10) Reset Data Option
...
5) jsPDF and html2canvas – PDF Export
...
3) Visualize spending habits through charts
